define(["@grafana/data"], function(__WEBPACK_EXTERNAL_MODULE__grafana_data__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
  ...
  DataSource.prototype.query = function (request) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        to = range.to.valueOf();
        data = request.targets.map(function (target) {// Your code goes here.
        });
        return [2
        /*return*/
        , {
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_1__["DataSourcePlugin"](DataSource); //.setConfigEditor(ConfigEditor)
